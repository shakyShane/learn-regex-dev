...
//            "manyOf"      : { name: 'Many Of',  method: "manyOf",    type: "input", input: true }, // t
            "_or"          : { name: 'Or',       method: "or",       type: "single", input: false, listSortOrder: 9 }, //test √
            "_space"       : { name: 'Space',    method: "then",     type: "single", input: false, defaultParam: " ", listSortOrder: 10},
            "_anything"    : { name: 'Anything', method: "anything", type: "single", input: false, listSortOrder: 11 }, // test √
